                    ...
                    <p class="flex gap-2 items-center">
                        ...
                        <svg class="h-5 w-5 text-yellow-500" xmlns="http://www.w3.org/2000/svg" fill="none" aria-hidden="true" viewBox="0 0 24 24">
                            <circle
                                ...
                                stroke="currentColor"
                                stroke-width="2"
                                class="opacity-75"></circle>
                            <path
                                fill=" "
                                d="M12 2a10 10 0 100 20 10 10 0 100-20zM12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0z"></path>
                            <path
                                fill="currentColor"
                                d="M12 6a1 1 0 011 1v4h4a1 1 0 110 2h-6a1 1 0 01-1-1V7a1 1 0 011-1z"></path>
                        </svg>
                    </p>
                    ...
                    <div class="grid gap-2">
                        ...
                        <p class="flex gap-2 items-center">
                            <i
                                ...
                                :class="isValid ? 'bg-green-200 text-green-600 dark:!text-green-600' : 'bg-red-200 text-red-600'"></i>
